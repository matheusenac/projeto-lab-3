...
CREATE TABLE `item_carrinho` (
  `fk_carrinho` int DEFAULT NULL,
  `fk_produto` int DEFAULT NULL,
  `data_item` date NOT NULL,
  KEY `fk_carrinho` (`fk_carrinho`),
  KEY `fk_produto` (`fk_produto`),
  CONSTRAINT `item_carrinho_ibfk_1` FOREIGN KEY (`fk_carrinho`) REFERENCES `carrinho` (`id_carrinho`),
  CONSTRAINT `item_carrinho_ibfk_2` FOREIGN KEY (`fk_produto`) REFERENCES `produtos` (`id_produto`)
...
-- Dump completed on 2026-05-07  6:48:44
